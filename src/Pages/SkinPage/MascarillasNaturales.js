...
<br></br>
<p className="aviso">Antes de aplicarte cualquier mascarilla, sin importar tu tipo de piel, debes asegurarte de tener la piel preparada para que puedas aprovechar al máximo todos los beneficios del cuidado que estás a punto de darle a tu rostro.</p>
       <br></br>
        </div>
        <div className="contenedor-mascarillas">
            ...
            <button className="primary-buttons-masca"><a className="button-video-masca" target="_blank" href="https://www.youtube.com/watch?v=W9dZWqmMXAo">Video Tutorial</a></button>
            </div>
            <div className="proceso-img">
            ...
            <button className="primary-buttons-masca"><a className="button-video-masca" target="_blank" href="https://www.youtube.com/watch?v=wriXfQlzjww">Video Tutorial</a></button>
            </div>
            <div className="proceso-img">
            ...
            <button className="primary-buttons-masca"><a className="button-video-masca" target="_blank" href="https://www.youtube.com/watch?v=pMWwjA6rkDE">Video Tutorial</a></button>
            </div>
            <div className="proceso-img">
            ...
            <button className="primary-buttons-masca"><a className="button-video-masca" target="_blank" href="https://www.youtube.com/watch?v=RxOFpSpzunMhttps://www.youtube.com/watch?v=ss7WVctklw8">Video Tutorial</a></button>
            </div>
        </div>
        </>
    )
